<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="fas fa-plus me-2"></i>Nuevo Color</h2>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= BASE_URL ?>?c=Color&a=guardar" method="post" id="form-color">
                        <div class="mb-3">
                        ...
                        <div class="mb-4">
                            ...
                            <small id="preview-text" class="text-muted">#FFFFFF</small>
                        </div>
            ...
            <div class="alert alert-warning mt-3">
                ...
                <small>
                    • Los nombres deben ser únicos<br>
                    • Los códigos hexadecimales también deben ser únicos<br>
                    • No puedes eliminar un color que esté siendo usado por productos<br>
